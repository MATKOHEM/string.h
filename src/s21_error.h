...
#define ERR_FIRST 0
#define ERR_LAST 133
#define s21_string "Unknown error"
#define s21_error                                                              \
  {                                                                            \
...
#define s21_error                                                              \
  {                                                                            \
    "Undefined error: 0", "Operation not permitted",                           \
        ...
        "Shared library version mismatch", "Malformed Mach",                   \
